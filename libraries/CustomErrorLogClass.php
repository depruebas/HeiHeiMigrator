...
class CustomErrorLogClass
{
  ...
  function __construct()
  {
    ...
    $this->pathLogs = RUTA_LOGS.FILE_LOG;
  ...
  public function customError( $errno, $errstr, $errfile, $errline)
  {
    ...
    if ( ConfigClass::get("config.debug", "config")) DebugClass::SaveError( 'error', $txterror);
  ...
  public function CatchFatalError() 
  {
    ...
    if ( !empty($error))
    {
      ...
      if ( ConfigClass::get("config.debug", "config")) DebugClass::SaveError( 'error', $txt);
    }
